...
public class RelationalExpression implements IExpression {
    ...
    public RelationalExpression(IExpression expression1, IExpression expression2, String newOp){
    ...
    @Override
    public BoolValue evaluate(MyIDictionary<String, IValue> table, IHeap<Integer, IValue> heap) throws MyException {
        ...
        if (value1.getType().equals(new IntType())) {
            ...
            if (value2.getType().equals(new IntType())) {
                ...
                if (operand.equals("<"))
                    return new BoolValue(nValue1 < nValue2);
                if (operand.equals("<="))
                    return new BoolValue(nValue1 <= nValue2);
                if (operand.equals("=="))
                    return new BoolValue(nValue1 == nValue2);
